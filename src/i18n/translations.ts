    ...
    members: [
      {
        ...
        bio: [
          "Raditya Wardhana is a founder operator who has built an integrated mining and industrial services ecosystem through long-term vision and disciplined execution. Since 2006, he has expanded from quarry operations into a diversified portfolio covering mining, commercial explosives, drilling and blasting services, logistics, and enabling industrial technologies.",
          "With more than 15 years of hands-on leadership, he currently oversees three active mining operations in West Java and leads a vertically integrated platform focused on operational excellence, safety, regulatory compliance, and capital efficiency.",
          "To drive productivity and innovation, he founded BlastPro, introducing advanced drilling systems and LOx Breaker technology to enhance efficiency, precision, and safety. Today, five companies operate in synergy under PT Nusantara Karya Raya Indonesia, forming a resilient platform positioned for disciplined expansion, strategic partnerships, and long-term value creation.",
        ],
      ...
      },
      {
        ...
        bio: [
          "Dien Hartati is a senior corporate banking professional with more than a decade of experience, particularly in Corporate Banking. Her career was built within the banking industry, where she held a range of strategic roles from Account Manager to Assistant Vice President, managing large-scale corporate client portfolios, conducting rigorous credit analysis, and cultivating long-term, trust-based business relationships.",
          "As President Commissioner of PT Nusantara Karya Raya Indonesia, Dien plays a key role in safeguarding the company's strategic direction and governance framework, ensuring alignment with principles of sustainability, integrity, and long-term value creation.",
        ],
      ...
      },
      {
        ...
        bio: [
          "Sarah Shivina is a senior finance executive with over 25 years of experience across banking, logistics, mining, education, and international operations. With a strong academic foundation in finance and international business management, she brings a rare combination of strategic insight and hands-on operational leadership.",
          "As Finance Director of PT Nusantara Karya Raya Indonesia, Sarah leads strategic financial planning and strengthens the Group's financial structure, supporting disciplined growth and long-term value creation.",
        ],
      ...
      },
      {
        ...
        bio: [
          "Stefaan De Beleyr is a senior technology and business professional with more than 25 years of cross-industry experience spanning oil and gas, logistics, and information technology in Europe. After building his career in Belgium, he is now based in Jakarta, where he leads digital transformation and enterprise information systems at PT Nusantara Karya Raya Indonesia.",
          "As Chief Technology Officer, Stefaan drives the company's digital strategy to enhance operational efficiency, data-driven decision-making, and long-term innovation.",
        ],
      ...
      },
      {
        ...
        bio: [
          "Arie Arrachman is a seasoned finance and accounting professional with more than 20 years of experience across banking and corporate sectors. His career progressed from customer-facing and card services roles into SME banking, where he later earned the trust to lead a branch as Branch Manager at one of Indonesia's largest state-owned banks.",
          "Currently, he holds a strategic role as Finance & Accounting Manager at PT Nusantara Karya Raya Indonesia, overseeing group-level treasury operations and ensuring financial continuity across its subsidiaries.",
        ],
    ...
    members: [
      {
        ...
        photo: "/images/bod-raditya.webp",
        bio: [
          "Raditya Wardhana adalah pendiri dan operator yang membangun ekosistem layanan pertambangan dan industri terintegrasi melalui visi jangka panjang dan eksekusi yang disiplin. Sejak 2006, ia mengembangkan portofolio dari operasi tambang batu menjadi portofolio terdiversifikasi meliputi pertambangan, bahan peledak komersial, jasa pengeboran dan peledakan, logistik, serta teknologi industri.",
          "Dengan lebih dari 15 tahun kepemimpinan langsung, ia saat ini mengawasi tiga operasi pertambangan aktif di Jawa Barat dan memimpin platform terintegrasi vertikal yang berfokus pada keunggulan operasional, keselamatan, kepatuhan regulasi, dan efisiensi modal.",
          "Untuk mendorong produktivitas dan inovasi, ia mendirikan BlastPro, memperkenalkan sistem pengeboran canggih dan teknologi LOx Breaker untuk meningkatkan efisiensi, presisi, dan keselamatan. Saat ini, lima perusahaan beroperasi secara sinergis di bawah PT Nusantara Karya Raya Indonesia, membentuk platform tangguh yang siap untuk ekspansi terdisiplin, kemitraan strategis, dan penciptaan nilai jangka panjang.",
        ],
      ...
      },
      {
        ...
        photo: "/images/bod-dien.webp",
        bio: [
          "Dien Hartati adalah profesional perbankan korporat senior dengan pengalaman lebih dari satu dekade, khususnya di bidang Perbankan Korporasi. Kariernya dibangun dalam industri perbankan, di mana ia memegang berbagai peran strategis mulai dari Account Manager hingga Assistant Vice President, mengelola portofolio klien korporat berskala besar, melakukan analisis kredit yang ketat, dan membangun hubungan bisnis jangka panjang berbasis kepercayaan.",
          "Sebagai Komisaris Utama PT Nusantara Karya Raya Indonesia, Dien memainkan peran kunci dalam menjaga arah strategis dan kerangka tata kelola perusahaan, memastikan keselarasan dengan prinsip keberlanjutan, integritas, dan penciptaan nilai jangka panjang.",
        ],
      ...
      },
      {
        ...
        photo: "/images/bod-sarah.webp",
        bio: [
          "Sarah Shivina adalah eksekutif keuangan senior dengan pengalaman lebih dari 25 tahun di bidang perbankan, logistik, pertambangan, pendidikan, dan operasi internasional. Dengan fondasi akademik yang kuat di bidang keuangan dan manajemen bisnis internasional, ia membawa kombinasi langka antara wawasan strategis dan kepemimpinan operasional langsung.",
          "Sebagai Direktur Keuangan PT Nusantara Karya Raya Indonesia, Sarah memimpin perencanaan keuangan strategis dan memperkuat struktur keuangan Grup, mendukung pertumbuhan terdisiplin dan penciptaan nilai jangka panjang.",
        ],
      ...
      },
      {
        ...
        photo: "/images/bod-stefaan.webp",
        bio: [
          "Stefaan De Beleyr adalah profesional teknologi dan bisnis senior dengan pengalaman lebih dari 25 tahun lintas industri meliputi minyak dan gas, logistik, dan teknologi informasi di Eropa. Setelah membangun kariernya di Belgia, ia kini berbasis di Jakarta, di mana ia memimpin transformasi digital dan sistem informasi enterprise di PT Nusantara Karya Raya Indonesia.",
          "Sebagai Chief Technology Officer, Stefaan mendorong strategi digital perusahaan untuk meningkatkan efisiensi operasional, pengambilan keputusan berbasis data, dan inovasi jangka panjang.",
        ],
      ...
      },
      {
        ...
        photo: "/images/bod-arie.webp",
        bio: [
          "Arie Arrachman adalah profesional keuangan dan akuntansi berpengalaman dengan lebih dari 20 tahun pengalaman di sektor perbankan dan korporasi. Kariernya berkembang dari peran layanan nasabah ke perbankan UKM, di mana ia kemudian dipercaya memimpin cabang sebagai Branch Manager di salah satu bank BUMN terbesar di Indonesia.",
          "Saat ini, ia memegang peran strategis sebagai Manajer Keuangan & Akuntansi di PT Nusantara Karya Raya Indonesia, mengawasi operasi perbendaharaan tingkat grup dan memastikan kelangsungan keuangan di seluruh anak perusahaan.",
        ],
